...
Ready to practice? Try these problems:

1. **[Problem 1: Reverse a Linked List](./problem1.md)** - Easy 🟢
2. **[Problem 2: Detect Cycle](./problem2.md)** - Easy 🟢
3. **[Problem 3: Middle of Linked List](./problem3.md)** - Medium 🟡
4. **[Problem 4: Merge Two Sorted Lists](./problem4.md)** - Medium 🟡
5. **[Problem 5: Remove Nth From End](./problem5.md)** - Medium 🟡
6. **[Problem 6: Add Two Numbers](./problem6.md)** - Hard 🔴
