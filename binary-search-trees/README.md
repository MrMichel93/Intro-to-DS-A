...
Master BSTs with these problems:

1. **[Problem 1: Validate BST](./problem1.md)** - Easy 🟢
2. **[Problem 2: Kth Smallest](./problem2.md)** - Easy 🟢
3. **[Problem 3: Lowest Common Ancestor](./problem3.md)** - Medium 🟡
4. **[Problem 4: Convert Sorted Array to BST](./problem4.md)** - Medium 🟡
5. **[Problem 5: Delete Node in BST](./problem5.md)** - Medium 🟡
6. **[Problem 6: BST Iterator](./problem6.md)** - Hard 🔴
